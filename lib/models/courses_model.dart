...
List<Course> allCourses = [
  Course(
      ...
      links: [
        ...
        Links(
            ...
            url: 'https://youtu.be/iyxqcS1u5go?si=I7dXyDMJEmNljO0_',
            video: true),
        Links(
  ...
  Course(
      ...
      description:
          'لغة البايثون هي لغة برمجة عالية المستوى تم تطويرها في أوائل التسعينيات من قبل غويدو فان روسوم. تتميز بسهولة قراءة الشفرة وبناءها، مما يجعلها مثالية للمبتدئين ولكنها قوية ومرنة بما يكفي لتلبية احتياجات المطورين المحترفين. تستخدم في مجموعة متنوعة من التطبيقات بما في ذلك تطوير الويب، وعلم البيانات، والذكاء الاصطناعي، والتطبيقات المحمولة، والأتمتة، وغيرها الكثير.',
      links: [
        Links(
            name: '${beginners}(Coursera)',
            url:
        ...
        Links(
            name: '${beginners}(Udemy)',
            url:
                'https://www.udemy.com/course/machinelearning/?couponCode=LEADERSALE24A',
            video: false),
        Links(
            name: '${beginners}(Youtube channel)',
  ...
  Course(
      ...
      description:
          'MySQL هو نظام إدارة قواعد البيانات الشهير والمفتوح المصدر. تم تطويره بواسطة شركة MySQL AB التي تأسست في عام 1995، والتي تم استحواذها فيما بعد بواسطة شركة Sun Microsystems ومن ثم Oracle Corporation. MySQL يعتبر أحد أنظمة إدارة قواعد البيانات الأكثر استخدامًا في العالم، ويُستخدم في تطوير تطبيقات الويب والأنظمة الخلفية للعديد من المواقع والخدمات الإلكترونية. يتميز MySQL بالسرعة والموثوقية والسهولة في الاستخدام، بالإضافة إلى دعمه الواسع للغات المختلفة مثل PHP وPython وJava وغيرها، مما يجعله محط أنظار المطورين في مختلف المجالات.',
      links: [
        Links(
            name: '${beginners}(Coursera)',
            url:
                'https://www.coursera.org/professional-certificates/ibm-data-science?utm_medium=sem&utm_source=gg&utm_campaign=b2c_emea_ibm-data-science_ibm_ftcof_professional-certificates_arte_april_24_dr_geo-multi-set3_pmax_gads_lg-all&campaignid=21182631281&adgroupid=&device=c&keyword=&matchtype=&network=x&devicemodel=&adposition=&creativeid=&hide_mobile_promo&gad_source=1&gclid=EAIaIQobChMIsJnVrr6VhgMVFURBAh2XtA5LEAAYASAAEgKnF_D_BwE',
            video: false),
        Links(
            name: '${beginners}(Udemy)',
            url:
                'https://www.udemy.com/topic/SQL/?utm_source=adwords&utm_medium=udemyads&utm_campaign=Branded-Topic_la.EN_cc.ROW&campaigntype=Search&portfolio=BrandTopic&language=EN&product=Course&test=&audience=Keyword&topic=&priority=&utm_content=deal4584&utm_term=_._ag_122656852998_._ad_535757779826_._kw_sql%20classes%20udemy_._de_c_._dm__._pl__._ti_kwd-1940027648287_._li_9112361_._pd__._&matchtype=b&gad_source=1&gclid=EAIaIQobChMI2u_Mu76VhgMVhj4GAB3rKgZuEAAYASAAEgJ6PvD_BwE',
            video: false),
        Links(
            name: '${beginners}(Youtube channel)',
  ...
  Course(
      ...
      description:
          'MongoDB هو نظام إدارة قواعد البيانات غير العلاقية (NoSQL) المفتوح المصدر. تم تطويره بلغة البرمجة C++ ويوفر تخزينًا مرنًا وقابل للتوسع للبيانات غير المهيكلة، مثل الوثائق والملفات والبيانات الشبيهة بال JSON. يتميز MongoDB بالسرعة والقدرة على التكيف مع التطبيقات ذات الحملات الثقيلة، مما جعله شائعًا في مجالات مثل التطبيقات الويب، والتحليل الضخم للبيانات، وتطبيقات الألعاب، والأنظمة الموزعة.',
      links: [
        Links(
            name: '${beginners}(Coursera)',
  ...
  Course(
      ...
      description:
          'خوارزميات التعلم الآلي (Machine Learning Algorithms) هي مجموعة من الأساليب والتقنيات التي تستخدم في تطوير نماذج التعلم الآلي لتحليل البيانات واستخلاص الأنماط واتخاذ القرارات التنبؤية. هذه الخوارزميات تتنوع بشكل كبير ويتم اختيارها وفقًا لنوع المشكلة ونوع البيانات والأهداف المرجوة. ',
      links: [
        Links(
            name: '${beginners}(Coursera)',
  ...
  Course(
      name: '$course7',
      imageUrl: 'assets/images/deep.png',
      description:
          'التعلم العميق (Deep Learning) هو فرع من فروع التعلم الآلي يركز على استخدام الشبكات العصبية الاصطناعية لتعلم البيانات المتوافرة. يعتبر التعلم العميق عبارة عن عملية تلقائية لتمثيل البيانات بطريقة تدرجاتية من الطبقات المتعددة، تسمى الشبكات العصبية العميقة',
      links: [
        Links(
            name: '${beginners}(Coursera)',
            url:
  ...
  Course(
      ...
      description:
          'توجد العديد من الأدوات المستخدمة لتصور البيانات (Data Visualization)، والتي تهدف إلى تحويل البيانات إلى صور ورسوم بيانية سهلة الفهم والتي تسهل على المستخدمين فهم النماذج والاتجاهات والعلاقات في البيانات.',
      links: [
        Links(
            name: '${beginners}(Coursera)',
            url:
  ...
  Course(
      ...
      description:
          'HTML (HyperText Markup Language)، CSS (Cascading Style Sheets)، وJavaScript هي الأساسيات الثلاثة لتطوير صفحات الويب التفاعلية',
      links: [
        Links(
        ...
        Links(
            ...
            url:
                'https://www.coursera.org/search?query=web%20development%20css',
            video: false),
        Links(
            name: 'HTML Courses(Udemy)',
            url: 'https://www.udemy.com/topic/html/',
            video: false),
        Links(
            name: 'CSS Courses(Udemy)',
            url: 'https://www.udemy.com/topic/css/',
            video: false),
        Links(
  ...
  Course(
      ...
      description:
          'تطوير الواجهة الأمامية (Front-end Development) هو عملية تطوير وبناء جزء الواجهة الرئيسي لموقع الويب أو تطبيق الويب. يتمثل دور مطور الواجهة الأمامية في تحويل التصاميم والمتطلبات إلى صفحات واجهة مستخدم قابلة للتفاعل وسهلة الاستخدام.',
      links: [
        Links(
  ...
  Course(
      ...
      description:
          'PHP تعتبر اختصارًا لـ "Hypertext Preprocessor". إنها لغة برمجة سكريبت مفتوحة المصدر تستخدم أساسًا في تطوير تطبيقات الويب والصفحات الديناميكية. تم تطوير PHP بواسطة راسموس ليردورف في عام 1994، وهو يعتبر واحدًا من أكثر لغات البرمجة شيوعًا في عالم تطوير الويب.',
      links: [
        Links(
  ...
  Course(
      name: '$course12',
      imageUrl: 'assets/images/node-js.png',
      description:
          'Node.js هو بيئة تشغيل (runtime environment) لتنفيذ الكود المكتوب بلغة JavaScript خارج المتصفح. يعتمد Node.js على محرك V8 JavaScript engine المستخدم أساسًا في متصفح Google Chrome. تم تطوير Node.js بواسطة راين دال في عام 2009.',
      links: [
        Links(
  ...
  Course(
      name: '$course14',
      imageUrl: 'assets/images/python2.png',
      description:
          'لغة البايثون هي لغة برمجة عالية المستوى تم تطويرها في أوائل التسعينيات من قبل غويدو فان روسوم. تتميز بسهولة قراءة الشفرة وبناءها، مما يجعلها مثالية للمبتدئين ولكنها قوية ومرنة بما يكفي لتلبية احتياجات المطورين المحترفين. تستخدم في مجموعة متنوعة من التطبيقات بما في ذلك تطوير الويب، وعلم البيانات، والذكاء الاصطناعي، والتطبيقات المحمولة، والأتمتة، وغيرها الكثير.',
      links: [
        Links(
  ...
  Course(
      name: '$course15',
      imageUrl: 'assets/images/full.png',
      description:
  ...
  Course(
      ...
      description:
          'هي عملية قيادة فريق لتحقيق جميع أهداف المشروع ضمن القيود المحددة. تُوصف هذه المعلومات عادة في وثائق المشروع، التي تُنشأ في بداية عملية التطوير. وتكمن التحديات الرئيسية في نطاق المشروع والوقت والميزانية.والتحدي الثانوي هو تحسين تخصيص الإمدادات اللازمة وتطبيقها لتحقيق الأهداف المحددة مسبقًا.',
      links: [
        Links(
  ...
  Course(
      name: '$course17',
      imageUrl: 'assets/images/software.png',
      description:
          'تطوير البرمجيات (Software Development) هو عملية إنشاء وتطوير البرمجيات التي تتضمن تصميم وتطوير واختبار وصيانة البرامج الحاسوبية.',
      links: [
        Links(
  ...
  Course(
      ...
      description:
          'HR تعني الموارد البشرية (Human Resources)، وهي القسم في المؤسسات والشركات المسؤول عن إدارة العمليات المتعلقة بالموظفين. ',
      links: [
        Links(
        ...
        Links(
            ...
            url:
                'https://www.youtube.com/watch?v=c6KUz-2W0oQ&list=PLmFxJ_siqsf_GeZXK8HrAw4h0pDNwnbXe&index=1',
            video: true),
        Links(
            name: 'HR basics(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=A2HFusWQIeE&list=PLdinyWzDfipPVYqpTc8EhWNDvEx14Nc1E&index=1',
            video: true),
        Links(
            name: 'I am HR(YouTube channel)',
            url: 'https://www.youtube.com/watch?v=05ZycWvTILs&list=PLeuj-AmjixnD2z_a8gqd0LTUQBKr-y0YW',
            video: true),
        Links(
        ...
        Links(
            ...
            url: 'https://www.youtube.com/watch?v=syE_5nqVEH4&list=PLpXwDvNS9MYlTExbQ_G2DeLEGo99pmLmd',
            video: true),
        Links(
        ...
        Links(
            name:
                'أقوى وظيفة ممكن تشتغلها وتكتسب منها خبرة قوية(YouTube channel)',
            url:
  ...
  Course(
      ...
      links: [
        ...
        Links(
            ...
            url:
                'https://www.youtube.com/watch?v=QB8A1KcAg5E&list=PL4xeUOr3Yk9fzRsSYdITG-4t12_35NHIF&index=1',
            video: true),
        Links(
        ...
        Links(
            ...
            url:
                'https://www.youtube.com/watch?v=WONZVnlam6U&list=PLYfCBK8IplO4E2sXtdKMVpKJZRBEoMvpn&index=1',
            video: true),
        Links(
            name: 'Adobe InDesign Tutorials(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=Zllc8LkBkXo&list=PLkiM1tZke4mjYGYEoVUtnIwYT0V9sYc2u&index=1',
            video: true),
        Links(
            name: 'Adobe Illustrator Tutorials(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=vTq_CMP2ogY&list=PLkiM1tZke4mgObgITi5FL01sDHpz8wxx1&index=1',
            video: true),
        Links(
            name: 'Adobe Photoshop Tutorials(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=vTq_CMP2ogY&list=PLkiM1tZke4mgnuOBy1ORT_Ssha7cVOpjl&index=1',
            video: true),
        Links(
            name: 'Design Review(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=JMKdZLYQMB0&list=PLkiM1tZke4mhszWKjVremOJcppTZm8w9V&index=1',
            video: true),
        Links(
        ...
        Links(
            ...
            url:
                'https://www.youtube.com/watch?v=Fm0uikrZaYY&list=PLZ5zEGbaMXXUIQRJ8XamBYdNrdALIljS1&index=1',
            video: true),
        Links(
            name: 'Adobe Illustrator CC Course(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=agpFGqIA1zc&list=PLg9ps5Gu0MiC_T2Spv3tMmmQjhpCrKC7Z&index=1',
            video: true),
        Links(
            name: 'قواعد التصميم الأكاديمية(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=aJ-AuZe0V4M&list=PLPTNqXpQ2tbgmAshpoR02QO4BfyWX3Dzs&index=1',
            video: true),
        Links(
            name: 'Mohamed Khayal graphic designer(YouTube channel)',
            url: 'https://www.youtube.com/watch?v=GOM8LtWXdaE',
            video: true),
        Links(
            name: 'دروس تصميم جرافيك(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=qyzHvMWiTi8&list=PL-7v-vvT0mkYyV6wakASLTekOooTpRRTx&index=1',
            video: true),
        Links(
            name:
                'التصميم الاعلاني والتجاري | المطبوعات الورقية(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=tEnNqLZ3To8&list=PL-7v-vvT0mkZZwZnOb4f7zhgyYXV7BI4A&index=1',
            video: true),
        Links(
            name: 'قواعد التصميم الأكاديمية(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=aJ-AuZe0V4M&list=PLPTNqXpQ2tbgmAshpoR02QO4BfyWX3Dzs&index=1&t=11s',
            video: true),
        Links(
            name: 'دورة الموشن جرافيك(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=Q8d23ADJ9MI&list=PLjG8az75XQywYb6KduNBmHUKTxRmVG63M&index=1',
            video: true),
        Links(
            name: 'كيف تبدأ كمصمم جرافيك(YouTube channel)',
            url:
                'https://www.youtube.com/watch?v=FgtjOIjdxWk&list=PLZ5zEGbaMXXXVYRa3t4ZE1jtSrGAfFkbr&index=1',
            video: true),
      ]),
  //20
  Course(
  ...
  Course(
      ...
      description:
          'البرمجة هي عملية كتابة تعليمات محددة للكمبيوتر لتنفيذ مهمة معينة. تتطلب عملية البرمجة استخدام لغة برمجة محددة، وهي مجموعة من القواعد والتركيبات التي يمكن من خلالها كتابة التعليمات وتفسيرها من قبل الحاسوب.',
      links: [
        Links(
            name: 'دورات برمجة',
        ...
        Links(
            name: "Linked In",
            url: 'https://linkedin-learning.pxf.io/kjaze3',
            video: false),
        Links(
            name: "Code School",
  ...
  Course(
      name: course22,
      imageUrl: 'assets/images/SAP.png',
      links: [
        Links(
            name: 'تعريف ومقدمة لل SAP',
            url: 'https://www.youtube.com/watch?v=8KfhxlxFh4s',
            video: true),
        Links(
            name: 'SAP General شرح بالعربي ',
            url:
                'https://www.youtube.com/watch?v=eTfTvaDAoT0&list=PLLlr6jKKdyK0FNZxYwSzss1cJGScxK3kd&index=1',
            video: true),
        Links(
            name: 'الساب المحاسبي',
            url: 'https://www.youtube.com/watch?v=92pQFdmT4F8&feature=youtu.be',
            video: true),
        Links(
            name: 'الساب المحاسبي',
            url: 'https://www.youtube.com/watch?v=j14QYFNyl7E&feature=youtu.be',
            video: true),
        Links(
            name: 'ساب بيزنس وان ',
            url: 'https://www.youtube.com/watch?v=nyRdMO6o1mc&feature=youtu.be',
            video: true),
        Links(
            name: 'ساب بيزنس وان ',
            url: 'https://www.youtube.com/watch?v=gXqTgy0u3Ms&feature=youtu.be',
            video: true),
        Links(
            name: 'ساب بيزنس وان ',
            url: 'https://www.youtube.com/watch?v=3Jes65r2GR8&feature=youtu.be',
            video: true),
        Links(
            name: 'ساب بيزنس وان موبايل ابلكيشن',
            url: 'https://www.youtube.com/watch?v=W2IFE3k_Ojg&feature=youtu.be',
            video: true),
      ],
      description:
          'SAP هي اختصار لـ "Systems, Applications & Products in Data Processing"، وهي شركة عالمية رائدة في مجال برامج تخطيط موارد المؤسسات (ERP). تأسست SAP في عام 1972 في ألمانيا، ومنذ ذلك الحين نمت لتصبح واحدة من أكبر الشركات البرمجية في العالم.'),
//23
Course(name: course23, imageUrl: 'assets/images/icdl.png', 
links: [
  Links(
    name:   'ExcelSheet', 
    url: 'https://fartshelwanedu-my.sharepoint.com/:x:/g/personal/hassan_hany_a03353_f-arts_helwan_edu_eg/EY0NHIIq2NRCg5pahHYsW7cB3HPxYt40PyloRBy7x39upg?e=YTb9Mf', 
    video: false),
    Links(
    name:   'شرح منهج أساسيات الكمبيوتر (الويندوز) عربي1 لشهادة ICDL Teacher', 
    url: 'https://www.youtube.com/watch?v=hGHXpodDqxw', 
    video: true),
    Links(
    name:   'edraak', 
    url: 'https://www.edraak.org/programs/specialization/icdlsp-vv1/', 
    video: false),
    Links(
    name:   'كامل مجاناً | أساسيات تكنولوجيا المعلومات والاتصالات', 
    url: 'https://www.youtube.com/watch?v=sPBlDYVDjLU&list=PL_2IpQXzdCUoPRsvrDmag9CKUSjVN-1ft&index=1', 
    video: true),
    Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=-S-wDU58Nq4&list=PL02NhKT84RvVhWh-fe82hLag-_5UWgJDB', 
    video: true),
     Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=7MFdTQTuH6M&list=PLEjoTL71aHXB3C0T-cBGwi0-Z7WgbbCDY', 
    video: true),
    Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=YAHoFEdZVI4&list=PLO9L9sHOfqhNtpqOlntL7ZSXDL_oNPXrI', 
    video: true),
        Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=vlQbZ07utfQ', 
    video: true),
     Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=_KgiNSouXRg&list=PLgAMlQtL0yOJ4Df5SzKMlLYt7V0dT5QztQ', 
    video: true),
         Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=W8UlY6NXZaY&list=PLkMQi7_Jt8puj8076gpv-7Vm8wa4ak-il', 
    video: true),
    Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=O5ClvxT1y0k&list=PLMZWNRHGu6pYJ8h4_MOya_1fF_p7czuNg', 
    video: true),
    Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=ntq32YZYM38&pp=ygUt2K_ZiNix2Kkg2KfZiiDYs9mKINiv2Yog2KfZhCDZhdmGINin2YTYtdmB2LEg', 
    video: true),
    Links(
    name:   'youtube', 
    url: 'https://www.youtube.com/watch?v=0zx_mFn6MH8&pp=ygUt2K_ZiNix2Kkg2KfZiiDYs9mKINiv2Yog2KfZhCDZhdmGINin2YTYtdmB2LEg', 
    video: true),
    
],
 description: 'ICDL هو اختصار لـ "International Computer Driving License"، وهو برنامج دولي للتدريب والاعتماد في مجال تكنولوجيا المعلومات والاتصالات (ICT). تم تطوير برنامج ICDL من قبل مؤسسة ICDL Foundation، وهو يهدف إلى تعزيز مهارات الحوسبة الأساسية لدى الأفراد في جميع أنحاء العالم.')
];
